...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x05parts\x18\x01 \x03(\v2\x12.inventory.v1.PartR\x05parts\"\xb3\x02\n" +
	"\n" +
	"PartFilter\x122\n" +
	...
	"\x04tags\x18\x05 \x03(\v2\x1c.google.protobuf.StringValueR\x04tags\"\xd5\x04\n" +
	"\x04Part\x12\x12\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBJZHgithub.com/Bladforceone/rocket/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	5,  // 1: inventory.v1.ListPartsRequest.filter:type_name -> inventory.v1.PartFilter
	6,  // 2: inventory.v1.ListPartsResponse.parts:type_name -> inventory.v1.Part
	11, // 3: inventory.v1.PartFilter.uuids:type_name -> google.protobuf.StringValue
	11, // 4: inventory.v1.PartFilter.names:type_name -> google.protobuf.StringValue
	0,  // 5: inventory.v1.PartFilter.categories:type_name -> inventory.v1.Category
	11, // 6: inventory.v1.PartFilter.manufacturer_countries:type_name -> google.protobuf.StringValue
	11, // 7: inventory.v1.PartFilter.tags:type_name -> google.protobuf.StringValue
	0,  // 8: inventory.v1.Part.category:type_name -> inventory.v1.Category
	7,  // 9: inventory.v1.Part.dimensions:type_name -> inventory.v1.Dimensions
	...
	9,  // 14: inventory.v1.Part.MetadataEntry.value:type_name -> inventory.v1.Value
	1,  // 15: inventory.v1.InventoryService.GetPart:input_type -> inventory.v1.GetPartRequest
	3,  // 16: inventory.v1.InventoryService.ListParts:input_type -> inventory.v1.ListPartsRequest
	2,  // 17: inventory.v1.InventoryService.GetPart:output_type -> inventory.v1.GetPartResponse
	4,  // 18: inventory.v1.InventoryService.ListParts:output_type -> inventory.v1.ListPartsResponse
